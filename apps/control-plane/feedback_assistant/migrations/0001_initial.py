    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=list,
                        help_text="List of rubric criterion IDs",
                    ),
                ),
                ...
                (
                    "opening_template",
                    models.TextField(
                        default="Dear {student_name},",
                        help_text="Opening statement template",
                    ),
                ),
                (
                    "strengths_template",
                    models.TextField(
                        blank=True, default="Your strengths include: {strengths}"
                    ),
                ),
                (
                    "improvements_template",
                    models.TextField(
                        blank=True, default="Areas for improvement: {improvements}"
                    ),
                ),
                (
                    "next_steps_template",
                    models.TextField(blank=True, default="Next steps: {next_steps}"),
                ),
                (
                    "closing_template",
                    models.TextField(blank=True, default="Keep up the great work!"),
                ),
                (
                    "positivity_level",
                    models.IntegerField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "excellent_feedback",
                    models.TextField(help_text="Feedback for excellent performance"),
                ),
                (
                    "good_feedback",
                    models.TextField(help_text="Feedback for good performance"),
                ),
                (
                    "satisfactory_feedback",
                    models.TextField(help_text="Feedback for satisfactory performance"),
                ),
                (
                    "needs_improvement_feedback",
                    models.TextField(help_text="Feedback for needs improvement"),
                ),
                (
                    "weight",
                    models.FloatField(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="feedback_assistant.feedbacktemplate",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=dict,
                        help_text="Scores per rubric criterion",
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="e.g., Grade 10, University",
                        max_length=50,
                    ),
                ),
                (
                ...
                (
                    "delivery_method",
                    models.CharField(
                        blank=True, help_text="email, LMS, portal, etc.", max_length=50
                    ),
                ),
                (
                    "status",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="generated_feedbacks",
                        to="feedback_assistant.feedbacktemplate",
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="logs",
                        to="feedback_assistant.generatedfeedback",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["tenant", "status"], name="feedback_as_tenant_7c84e7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="feedbacktemplate",
            index=models.Index(
                fields=["feedback_type"], name="feedback_as_feedbac_099d5f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="feedbacktemplate",
            index=models.Index(
                fields=["created_at"], name="feedback_as_created_c1a35d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="generatedfeedback",
            index=models.Index(
                fields=["template", "status"], name="feedback_as_templat_7d8b02_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="generatedfeedback",
            index=models.Index(
                fields=["student_id"], name="feedback_as_student_e2ae18_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="generatedfeedback",
            index=models.Index(
                fields=["requires_review"], name="feedback_as_require_c73674_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="generatedfeedback",
            index=models.Index(
                fields=["generated_at"], name="feedback_as_generat_fb6a2e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="feedbacklog",
            index=models.Index(
                fields=["template", "action"], name="feedback_as_templat_4851a5_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="feedbacklog",
            index=models.Index(
                fields=["timestamp"], name="feedback_as_timesta_c0fafb_idx"
            ),
        ),
    ]
