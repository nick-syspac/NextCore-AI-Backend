...
class TASViewSet(viewsets.ModelViewSet):
    ...
    def _generate_section_content(self, section_name, data, prompt):
        ...
        templates = {
            ...
            """,
            "units_of_competency": self._generate_units_section(
                data.get("units_of_competency", [])
            ),
            "delivery_strategy": f"""
            ...
            """,
            "assessment_strategy": self._generate_assessment_section(
        ...
        return {
            ...
            "content": templates.get(
                section_name, f"<p>Content for {section_name}</p>"
            ),
    ...
    def _generate_units_section(self, units):
        ...
        html += (
            '<thead><tr><th style="border:1px solid #ddd; padding:8px;">Unit Code</th>'
        )
    ...
    def update_content(self, request, tenant_slug=None, pk=None):
        ...
        if create_version:
            ...
            if "sections" in data:
                new_section_names = {
                    s.get("name") for s in data["sections"] if isinstance(s, dict)
                }
                old_section_names = {
                    s.get("name") for s in old_sections if isinstance(s, dict)
                }
    ...
    def versions(self, request, tenant_slug=None, pk=None):
        ...
        tas = self.get_object()
        versions = TAS.objects.filter(tenant=tas.tenant, code=tas.code).order_by(
            "-version"
        )
    ...
    def regenerate_section(self, request, tenant_slug=None, pk=None):
        ...
        try:
            ...
            new_section = self._generate_section_content(
                section_name, section_data, custom_prompt
            )
    ...
    def _get_qualifications_data(self):
        ...
        return [
            ...
            {
                "code": "BSB10120",
                "title": "Certificate I in Workplace Skills",
                "aqf_level": "certificate_i",
                "training_package": "BSB",
            },
            {
                "code": "BSB20120",
                "title": "Certificate II in Workplace Skills",
                "aqf_level": "certificate_ii",
                "training_package": "BSB",
            },
            {
                "code": "BSB30120",
            ...
            {
                "code": "ICT50220",
                "title": "Diploma of Information Technology (Advanced Networking)",
                "aqf_level": "diploma",
                "training_package": "ICT",
            },
            {
                "code": "ICT50420",
                "title": "Diploma of Information Technology (Back End Development)",
                "aqf_level": "diploma",
                "training_package": "ICT",
            },
            {
                "code": "ICT50620",
                "title": "Diploma of Information Technology (Cyber Security)",
                "aqf_level": "diploma",
                "training_package": "ICT",
            },
            {
            ...
            {
                "code": "ICT60220",
                "title": "Advanced Diploma of Information Technology (Network Security)",
                "aqf_level": "advanced_diploma",
                "training_package": "ICT",
            },
            ...
            {
                "code": "CHC62015",
                "title": "Advanced Diploma of Community Sector Management",
                "aqf_level": "advanced_diploma",
                "training_package": "CHC",
            },
            # Hospitality (SIT)
            ...
            {
                "code": "SIR20216",
                "title": "Certificate II in Retail Services",
                "aqf_level": "certificate_ii",
                "training_package": "SIR",
            },
            {
                "code": "SIR30216",
                "title": "Certificate III in Retail",
                "aqf_level": "certificate_iii",
                "training_package": "SIR",
            },
            {
                "code": "SIR40216",
                "title": "Certificate IV in Retail Management",
                "aqf_level": "certificate_iv",
                "training_package": "SIR",
            },
            {
                "code": "SIR50217",
                "title": "Diploma of Retail Management",
                "aqf_level": "diploma",
                "training_package": "SIR",
            },
            ...
            {
                "code": "TAE50216",
                "title": "Diploma of Training Design and Development",
                "aqf_level": "diploma",
                "training_package": "TAE",
            },
            {
                "code": "TAE50116",
                "title": "Diploma of Vocational Education and Training",
                "aqf_level": "diploma",
                "training_package": "TAE",
            },
            # Health (HLT)
            ...
            {
                "code": "HLT37315",
                "title": "Certificate III in Sterilisation Services",
                "aqf_level": "certificate_iii",
                "training_package": "HLT",
            },
            {
            ...
            {
                "code": "HLT47315",
                "title": "Certificate IV in Health Administration",
                "aqf_level": "certificate_iv",
                "training_package": "HLT",
            },
            {
    ...
    def _get_units_for_qualification(self, qual_code):
        ...
        try:
            ...
            cached_qual = QualificationCache.objects.filter(
                qualification_code=qual_code, is_active=True
            ).first()
                ...
                "groupings": [
                    {
                        ...
                        "units": [
                            ...
                            {
                                "code": "BSBTEC404",
                                "title": "Use digital technologies to collaborate in a work environment",
                                "type": "core",
                            },
                            {
                                "code": "ICTICT418",
                            ...
                            {
                                "code": "ICTICT426",
                                "title": "Identify and evaluate IP, ethics and privacy policies and procedures",
                                "type": "core",
                            },
                            {
                                "code": "ICTPRG431",
                                "title": "Apply query language",
                                "type": "core",
                            },
                            {
                                "code": "ICTSAS426",
                                "title": "Identify and resolve client ICT problems",
                                "type": "core",
                            },
                            {
                                "code": "ICTSAS432",
                                "title": "Identify and resolve network problems",
                                "type": "core",
                            },
                        ],
                    },
                    {
                        ...
                        "units": [
                            ...
                            {
                                "code": "ICTCLD402",
                                "title": "Design cloud computing environments",
                                "type": "elective",
                            },
                            {
                                "code": "ICTCLD501",
                                "title": "Plan for cloud computing implementation",
                                "type": "elective",
                            },
                            {
                                "code": "ICTCLD502",
                    ...
                    },
                    {
                        ...
                        "units": [
                            ...
                            {
                                "code": "ICTPRG430",
                                "title": "Apply introductory programming skills in another language",
                                "type": "elective",
                            },
                            {
                                "code": "ICTPRG433",
                                "title": "Test software developments",
                                "type": "elective",
                            },
                            {
                                "code": "ICTPRG434",
                                "title": "Design and implement data structures",
                                "type": "elective",
                            },
                            {
                                "code": "ICTPRG435",
                                "title": "Write script for software applications",
                                "type": "elective",
                            },
                        ],
                    },
                    {
                        ...
                        "units": [
                            {
                                "code": "ICTNWK411",
                                "title": "Maintain network servers",
                                "type": "elective",
                            },
                            {
                                "code": "ICTNWK418",
                                "title": "Install, configure and test network security",
                                "type": "elective",
                            },
                            {
                                "code": "ICTNWK421",
                                "title": "Install and configure network access storage devices",
                                "type": "elective",
                            },
                            {
                                "code": "ICTNWK422",
                                "title": "Install, configure and test network protocols",
                                "type": "elective",
                            },
                            {
                                "code": "ICTNWK429",
                                "title": "Install and manage network cabling infrastructure",
                                "type": "elective",
                            },
                        ],
                    },
                    {
                        ...
                        "units": [
                            {
                                "code": "ICTCYS401",
                                "title": "Apply introductory cyber security practices",
                                "type": "elective",
                            },
                            {
                                "code": "ICTCYS402",
                                "title": "Perform a cyber security role",
                                "type": "elective",
                            },
                            {
                                "code": "ICTCYS403",
                                "title": "Recognise and report potential security risks",
                                "type": "elective",
                            },
                            {
                                "code": "ICTCYS404",
                                "title": "Implement a security solution",
                                "type": "elective",
                            },
                            {
                                "code": "ICTCYS405",
                                "title": "Maintain secure network systems",
                                "type": "elective",
                            },
                        ],
                    },
                    {
                        ...
                        "units": [
                            ...
                            {
                                "code": "ICTSAD401",
                                "title": "Design and construct simple database",
                                "type": "elective",
                            },
                            {
                                "code": "ICTWEB425",
                                "title": "Apply structured query language to extract and manipulate data",
                                "type": "elective",
                            },
                            {
                                "code": "ICTWEB426",
                                "title": "Create and style simple markup language documents",
                                "type": "elective",
                            },
                            {
                                "code": "ICTWEB429",
                                "title": "Create a markup language document to specification",
                                "type": "elective",
                            },
                            {
                                "code": "ICTWEB430",
                                "title": "Produce server-side script for dynamic web pages",
                                "type": "elective",
                            },
                        ],
                    },
                ...
                "groupings": [
                    {
                        ...
                        "units": [
                            {
                                "code": "BSBCRT511",
                                "title": "Develop critical thinking in others",
                                "type": "core",
                            },
                            {
                                "code": "BSBFIN501",
                    ...
                    },
                    {
                        ...
                        "units": [
                            ...
                            {
                                "code": "BSBINS501",
                                "title": "Implement information and knowledge management systems",
                                "type": "elective",
                            },
                            {
                                "code": "BSBMGT516",
                                "title": "Facilitate continuous improvement",
                                "type": "elective",
                            },
                            {
                                "code": "BSBMGT517",
                            ...
                            {
                                "code": "BSBTEC501",
                                "title": "Develop and implement organisational digital strategy",
                                "type": "elective",
                            },
                        ],
                    },
                ...
                "groupings": [
                    {
                        ...
                        "units": [
                            {
                                "code": "CHCECE030",
                                "title": "Support inclusion and diversity",
                                "type": "core",
                            },
                            {
                                "code": "CHCECE031",
                                "title": "Support children's health, safety and wellbeing",
                                "type": "core",
                            },
                            {
                                "code": "CHCECE032",
                                "title": "Nurture babies and toddlers",
                                "type": "core",
                            },
                            {
                                "code": "CHCECE033",
                                "title": "Develop positive and respectful relationships with children",
                                "type": "core",
                            },
                            {
                                "code": "CHCECE034",
                                "title": "Use an approved learning framework to guide practice",
                                "type": "core",
                            },
                            {
                                "code": "CHCECE035",
                                "title": "Support the holistic development of children in early childhood",
                                "type": "core",
                            },
                            {
                                "code": "CHCECE036",
                                "title": "Provide experiences to support children's play and learning",
                                "type": "core",
                            },
                            {
                                "code": "CHCECE037",
                                "title": "Support children to connect with the natural environment",
                                "type": "core",
                            },
                            {
                                "code": "CHCECE038",
                                "title": "Observe children to inform practice",
                                "type": "core",
                            },
                            {
                                "code": "CHCECE041",
                                "title": "Maintain a safe and healthy environment for children",
                                "type": "core",
                            },
                            {
                                "code": "CHCPRT001",
                            ...
                            {
                                "code": "HLTWHS003",
                                "title": "Maintain work health and safety",
                                "type": "core",
                            },
                            {
                                "code": "CHCECE042",
                                "title": "Foster holistic early childhood development",
                                "type": "core",
                            },
                            {
                                "code": "CHCECE043",
                                "title": "Nurture creativity in children",
                                "type": "core",
                            },
                        ],
                    },
                    {
                        ...
                        "units": [
                            ...
                            {
                                "code": "CHCECE044",
                                "title": "Facilitate compliance in an education and care service",
                                "type": "elective",
                            },
                            {
                                "code": "CHCECE045",
                                "title": "Foster positive and respectful interactions and behaviour in children",
                                "type": "elective",
                            },
                            {
                                "code": "CHCECE046",
                                "title": "Implement strategies for the inclusion of all children",
                                "type": "elective",
                            },
                            {
                                "code": "CHCECE047",
                                "title": "Analyse information to inform learning",
                                "type": "elective",
                            },
                            {
                                "code": "CHCECE048",
                                "title": "Plan and implement children's education and care curriculum",
                                "type": "elective",
                            },
                            {
                                "code": "CHCECE049",
                                "title": "Embed environmental responsibility in service operations",
                                "type": "elective",
                            },
                            {
                                "code": "CHCECE050",
                                "title": "Work in partnership with children's families",
                                "type": "elective",
                            },
                            {
                                "code": "CHCECE051",
                                "title": "Lead practice that promotes well-being, builds resilience and supports children to participate in the curriculum",
                                "type": "elective",
                            },
                            {
                                "code": "CHCECE052",
                                "title": "Build and maintain reciprocal relationships to work effectively with families",
                                "type": "elective",
                            },
                            {
                                "code": "CHCECE053",
                                "title": "Respond to grievances and complaints about the service",
                                "type": "elective",
                            },
                            {
                                "code": "CHCECE054",
                                "title": "Encourage understanding of Aboriginal and/or Torres Strait Islander peoples' cultures",
                                "type": "elective",
                            },
                        ],
                    },
                ...
                "groupings": [
                    {
                        ...
                        "units": [
                            {
                                "code": "BSBDIV501",
                                "title": "Manage diversity in the workplace",
                                "type": "core",
                            },
                            {
                                "code": "BSBFIN501",
                            ...
                            {
                                "code": "SITXGLC001",
                                "title": "Research and comply with regulatory requirements",
                                "type": "core",
                            },
                            {
                                "code": "SITXHRM002",
                    ...
                    },
                    {
                        ...
                        "units": [
                            ...
                            {
                                "code": "SITHKOP005",
                                "title": "Coordinate cooking operations",
                                "type": "elective",
                            },
                            {
                                "code": "SITTTSL003",
                                "title": "Provide advice on Australian destinations",
                                "type": "elective",
                            },
                            {
                                "code": "SITTTSL004",
                                "title": "Provide advice on international destinations",
                                "type": "elective",
                            },
                            {
                                "code": "SITTTVL001",
                                "title": "Access and interpret product information",
                                "type": "elective",
                            },
                        ],
                    },
                ...
                "groupings": [
                    {
                        ...
                        "units": [
                            ...
                            {
                                "code": "BSBXCS303",
                                "title": "Securely manage personally identifiable information and workplace information",
                                "type": "core",
                            },
                        ],
                    },
                    {
                        ...
                        "units": [
                            ...
                            {
                                "code": "BSBCOM412",
                                "title": "Negotiate to achieve desired outcomes",
                                "type": "elective",
                            },
                            {
                                "code": "BSBFIN401",
                                "title": "Report on financial activity",
                                "type": "elective",
                            },
                            {
                                "code": "BSBINS402",
                                "title": "Coordinate workplace information systems",
                                "type": "elective",
                            },
                            {
                                "code": "BSBLEG414",
                                "title": "Apply legal principles in contract law matters",
                                "type": "elective",
                            },
                            {
                                "code": "BSBMGT412",
                            ...
                            {
                                "code": "BSBOPS402",
                                "title": "Coordinate business operational plans",
                                "type": "elective",
                            },
                            {
                                "code": "BSBPEF402",
                                "title": "Develop personal work priorities",
                                "type": "elective",
                            },
                            {
                                "code": "BSBPMG430",
                            ...
                            {
                                "code": "BSBTEC402",
                                "title": "Design and produce complex spreadsheets",
                                "type": "elective",
                            },
                            {
                                "code": "BSBWHS411",
                ...
                "groupings": [
                    ...
                    },
                    {
                        ...
                        "units": [
                            ...
                            {
                                "code": "BSBSTR501",
                                "title": "Establish innovative work environments",
                                "type": "elective",
                            },
                            {
                                "code": "BSBTEC501",
                            ...
                            {
                                "code": "BSBWHS516",
                                "title": "Contribute to developing, implementing and maintaining an organisation's WHS management system",
                                "type": "elective",
                            },
                        ],
                    },
                ...
                "groupings": [
                    {
                        ...
                        "units": [
                            {
                                "code": "FNSACC311",
                                "title": "Process financial transactions and extract interim reports",
                                "type": "core",
                            },
                            {
                                "code": "FNSACC321",
                                "title": "Process financial transactions and extract interim reports (with MYOB)",
                                "type": "core",
                            },
                            {
                                "code": "FNSACC416",
                                "title": "Set up and operate computerised accounting systems",
                                "type": "core",
                            },
                            {
                                "code": "FNSACC418",
                                "title": "Work effectively in the accounting and bookkeeping industry",
                                "type": "core",
                            },
                            {
                                "code": "FNSTPB411",
                                "title": "Complete business activity and instalment activity statements",
                                "type": "core",
                            },
                            {
                                "code": "FNSTPB412",
                                "title": "Establish and maintain payroll systems",
                                "type": "core",
                            },
                        ],
                    },
                    {
                        ...
                        "units": [
                            ...
                            {
                                "code": "BSBTEC401",
                                "title": "Design and develop complex text documents",
                                "type": "elective",
                            },
                            {
                                "code": "BSBTEC402",
                            ...
                            {
                                "code": "FNSACC415",
                                "title": "Make decisions in a legal context",
                                "type": "elective",
                            },
                            {
                                "code": "FNSTPB413",
                                "title": "Establish and maintain cash controls",
                                "type": "elective",
                            },
                        ],
                    },
                ...
                "groupings": [
                    {
                        ...
                        "units": [
                            ...
                            {
                                "code": "TAEDES402",
                                "title": "Use training packages and accredited courses to meet client needs",
                                "type": "core",
                            },
                            {
                                "code": "TAEDEL401",
                                "title": "Plan, organise and deliver group-based learning",
                                "type": "core",
                            },
                            {
                                "code": "TAEASS401",
                                "title": "Plan assessment activities and processes",
                                "type": "core",
                            },
                        ],
                    },
                    {
                        ...
                        "units": [
                            {
                                "code": "TAEDEL402",
                                "title": "Plan, organise and facilitate learning in the workplace",
                                "type": "elective",
                            },
                            {
                                "code": "TAEASS402",
                            ...
                            {
                                "code": "TAEASS403",
                                "title": "Participate in assessment validation",
                                "type": "elective",
                            },
                            {
                                "code": "TAEDEL301",
                            ...
                            {
                                "code": "TAELLN411",
                                "title": "Address adult language, literacy and numeracy skills",
                                "type": "elective",
                            },
                            {
                                "code": "TAEPDD401",
                            ...
                            {
                                "code": "TAEASS404",
                                "title": "Assess competence in an online environment",
                                "type": "elective",
                            },
                            {
                                "code": "TAEDES403",
                                "title": "Design and develop print-based learning resources",
                                "type": "elective",
                            },
                        ],
                    },
    ...
    def ai_detect_policy_drift(self, request, tenant_slug=None, pk=None):
        ...
        try:
            ...
            service = AIServiceFactory.get_service("compliance_rag")
            result = service.detect_policy_drift(tas_policy_refs, current_policies)
