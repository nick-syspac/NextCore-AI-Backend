    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_type', models.CharField(choices=[('general', 'General Template'), ('trade', 'Trade/Technical'), ('business', 'Business/Commerce'), ('health', 'Health/Community Services'), ('creative', 'Creative Industries'), ('hospitality', 'Hospitality/Tourism'), ('technology', 'Information Technology'), ('education', 'Education/Training')], default='general', max_length=50)),
                ...
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tas_templates_created', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(help_text='Qualification code (e.g., BSB50120)', max_length=50)),
                ...
                ('gpt_model_used', models.CharField(blank=True, help_text='GPT model version used', max_length=50)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('approved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tas_approved', to=settings.AUTH_USER_MODEL)),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tas_created', to=settings.AUTH_USER_MODEL)),
                ('reviewed_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tas_reviewed', to=settings.AUTH_USER_MODEL)),
                ('submitted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tas_submitted', to=settings.AUTH_USER_MODEL)),
                ('template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tas_documents', to='tas.tastemplate')),
                ('tenant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tas_documents', to='tenants.tenant')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tas', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='version_history', to='tas.tas')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('tas', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='generation_logs', to='tas.tas')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='tas',
            index=models.Index(fields=['tenant', 'status'], name='tas_documen_tenant__4ac7ea_idx'),
        ),
        migrations.AddIndex(
            model_name='tas',
            index=models.Index(fields=['tenant', 'code'], name='tas_documen_tenant__b9e5c8_idx'),
        ),
        migrations.AddIndex(
            model_name='tas',
            index=models.Index(fields=['created_at'], name='tas_documen_created_5f8b91_idx'),
        ),
    ]
