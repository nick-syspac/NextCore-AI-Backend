...
class TrainerProfileAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "Currency Status",
            {"fields": ("last_verified_date", "currency_status", "currency_score")},
        ),
        (
...
class VerificationScanAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Configuration", {"fields": ("sources_to_scan", "scan_status")}),
        (
            "Results",
            {"fields": ("total_items_found", "relevant_items_count", "currency_score")},
        ),
        ("Processing", {"fields": ("scan_duration_seconds", "error_message")}),
...
class LinkedInActivityAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Content", {"fields": ("title", "description", "url")}),
        ("Date Information", {"fields": ("activity_date", "date_text")}),
        (
            "Extracted Entities",
        ...
        ("Metadata", {"fields": ("raw_data", "extracted_at")}),
    )
...
class GitHubActivityAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Content", {"fields": ("repository_name", "title", "description", "url")}),
        ("Date Information", {"fields": ("activity_date", "last_updated")}),
        (
            "Repository Metadata",
            {"fields": ("language", "languages_used", "topics", "stars", "forks")},
        ),
        ("Extracted Entities", {"fields": ("technologies", "frameworks", "keywords")}),
        (
            "Relevance",
            {
                "fields": (
        ...
        ("Activity Metrics", {"fields": ("commits_count", "contributions_count")}),
        ("Metadata", {"fields": ("raw_data", "extracted_at")}),
    )
...
class CurrencyEvidenceAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Date Range", {"fields": ("evidence_start_date", "evidence_end_date")}),
        (
            "Metrics",
            {"fields": ("total_activities", "relevant_activities", "currency_score")},
        ),
        (
            "Evidence Metadata",
            {"fields": ("linkedin_activities_included", "github_activities_included")},
        ),
        ("File Storage", {"fields": ("file_format", "file_path", "file_size_kb")}),
        ("Compliance", {"fields": ("meets_rto_standards", "compliance_notes")}),
...
class EntityExtractionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Source", {"fields": ("source_url", "source_text")}),
        ("Extracted Entities", {"fields": ("entities", "entity_count")}),
        ("Confidence", {"fields": ("extraction_confidence",)}),
        ("Processing", {"fields": ("nlp_model_used", "processing_time_ms")}),
        ("Timestamps", {"fields": ("extracted_at",)}),
    )
