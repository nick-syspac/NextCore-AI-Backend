    ...
    operations = [
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="interventio_tenant_239ae4_idx",
                    ),
                    models.Index(
                        fields=["status", "priority_level"],
                        name="interventio_status_8e4ef3_idx",
                    ),
                    models.Index(
                        fields=["trigger_type", "intervention_type"],
                        name="interventio_trigger_340a03_idx",
                    ),
                ],
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="intervention_tracker.intervention",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant", "intervention", "-timestamp"],
                        name="interventio_tenant_6c9a81_idx",
                    ),
                    models.Index(
                        fields=["action_type", "-timestamp"],
                        name="interventio_action__edf0f7_idx",
                    ),
                ],
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="intervention_tracker.interventionworkflow",
                    ),
                ),
            ],
            options={
