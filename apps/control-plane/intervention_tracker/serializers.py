...
class InterventionOutcomeSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = '__all__'
        read_only_fields = ['outcome_number', 'improvement_percentage', 'target_achieved', 'created_at']
...
class InterventionListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Intervention
        fields = ['id', 'intervention_number', 'student_name', 'intervention_type',
                  'priority_level', 'status', 'action_taken_by', 'action_date',
                  'outcome_achieved', 'requires_followup', 'created_at']
...
class InterventionRuleSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = '__all__'
        read_only_fields = ['rule_number', 'last_triggered', 'trigger_count', 'created_at', 'updated_at']
