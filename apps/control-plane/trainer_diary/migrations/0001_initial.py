    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant", "trainer_id", "-session_date"],
                        name="trainer_dia_tenant_58863e_idx",
                    ),
                    models.Index(
                        fields=["session_date", "entry_status"],
                        name="trainer_dia_session_4e3472_idx",
                    ),
                    models.Index(
                        fields=["course_code", "-session_date"],
                        name="trainer_dia_course__8bfe60_idx",
                    ),
                ],
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="trainer_diary.audiorecording",
                    ),
                ),
            ],
            options={
