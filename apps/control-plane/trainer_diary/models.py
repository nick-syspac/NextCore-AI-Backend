...
class AudioRecording(models.Model):
    ...
    diary_entry = models.ForeignKey(
        DiaryEntry, on_delete=models.CASCADE, related_name="recordings"
    )
...
class EvidenceDocument(models.Model):
    ...
    diary_entry = models.ForeignKey(
        DiaryEntry, on_delete=models.CASCADE, related_name="evidence_docs"
    )
...
class TranscriptionJob(models.Model):
    ...
    audio_recording = models.ForeignKey(
        AudioRecording, on_delete=models.CASCADE, related_name="transcription_jobs"
    )
