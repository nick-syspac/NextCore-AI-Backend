...
class DiaryEntryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Status", {"fields": ("entry_status", "is_pinned", "is_shared")}),
...
class AudioRecordingAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("recording_number", "diary_entry")}),
        (
            "Recording Details",
            {
                "fields": (
        ...
        ("Processing", {"fields": ("processing_status", "error_message")}),
...
class DailySummaryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Metadata", {"fields": ("generated_by_model", "generation_date")}),
    )
...
class EvidenceDocumentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Content", {"fields": ("document_content", "document_format")}),
        ("File Storage", {"fields": ("file_path", "file_size_kb")}),
        ("Metadata", {"fields": ("generated_by", "generation_method")}),
        ("Compliance", {"fields": ("meets_compliance_standards", "compliance_notes")}),
