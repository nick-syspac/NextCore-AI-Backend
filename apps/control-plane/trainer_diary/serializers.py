...
class DiaryEntryListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = DiaryEntry
        fields = [
            'id', 'entry_number', 'trainer_name', 'session_date', 'course_name',
            'session_duration_minutes', 'student_count', 'entry_status',
            'recordings_count', 'created_at'
        ]
...
class GenerateSummaryRequestSerializer(serializers.Serializer):
    ...
    summary_style = serializers.ChoiceField(
        choices=['brief', 'detailed', 'evidence_focused'],
        default='detailed'
    )
...
class GenerateEvidenceRequestSerializer(serializers.Serializer):
    ...
    document_type = serializers.ChoiceField(
        choices=[
            ...
            'assessment_record', 'student_feedback', 'compliance_report',
