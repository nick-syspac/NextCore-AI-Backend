...
class EvidenceMappingModelTest(TestCase):
    ...
    def test_mapping_number_generation(self):
        ...
        mapping1 = EvidenceMapping.objects.create(
            name="Mapping 1",
            created_by="user1"
        )
        mapping2 = EvidenceMapping.objects.create(
            name="Mapping 2",
            created_by="user2"
        )
...
class SubmissionEvidenceModelTest(TestCase):
    ...
    def test_text_extraction(self):
        ...
        self.assertEqual(submission.text_length, len("This is extracted text from the submission."))
