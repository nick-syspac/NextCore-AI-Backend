...
from .views import (
    EvidenceMappingViewSet, SubmissionEvidenceViewSet,
    CriteriaTagViewSet, EvidenceAuditViewSet, EmbeddingSearchViewSet
)

router = DefaultRouter()
router.register(r'mappings', EvidenceMappingViewSet, basename='evidencemapping')
router.register(r'submissions', SubmissionEvidenceViewSet, basename='submissionevidence')
