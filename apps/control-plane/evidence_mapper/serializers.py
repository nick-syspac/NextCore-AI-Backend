...
class EvidenceMappingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = '__all__'
        read_only_fields = ('mapping_number', 'created_at', 'updated_at', 'total_evidence_tagged',
...
class SubmissionEvidenceSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = '__all__'
        read_only_fields = ('evidence_number', 'created_at', 'text_length', 'total_tags', 'extracted_at')
...
class TagEvidenceRequestSerializer(serializers.Serializer):
    ...
    tag_type = serializers.ChoiceField(choices=CriteriaTag.TAG_TYPE_CHOICES, default='direct')
...
class SearchEmbeddingsRequestSerializer(serializers.Serializer):
    ...
    search_type = serializers.ChoiceField(
        choices=EmbeddingSearch.SEARCH_TYPE_CHOICES,
        default='similarity'
    )
