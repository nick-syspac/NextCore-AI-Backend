...
class PathwayRecommendationSerializer(serializers.ModelSerializer):
    pathway_name = serializers.CharField(
        source="recommended_pathway.pathway_name", read_only=True
    )
    pathway_description = serializers.CharField(
        source="recommended_pathway.description", read_only=True
    )
...
class RecommendationRequestSerializer(serializers.Serializer):
    ...
    time_commitment_hours = serializers.DecimalField(
        max_digits=4, decimal_places=1, required=False, default=10.0
    )
