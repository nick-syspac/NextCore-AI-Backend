    ...
    operations = [
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="adaptive_pa_student_b7032e_idx",
                    ),
                    models.Index(
                        fields=["status", "tenant"],
                        name="adaptive_pa_status_11cad3_idx",
                    ),
                    models.Index(
                        fields=["difficulty_level"],
                        name="adaptive_pa_difficu_078e40_idx",
                    ),
                ],
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="steps",
                        to="adaptive_pathway.learningpathway",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        to="adaptive_pathway.learningstep",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "expires_at",
                    models.DateTimeField(help_text="Recommendation expiry date"),
                ),
                (
                    "recommended_pathway",
                    models.ForeignKey(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="adaptive_pa_pathway_43bf9f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="learningstep",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["student_id", "-created_at"],
                name="adaptive_pa_student_a4b877_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="pathwayrecommendation",
            index=models.Index(
                fields=["is_accepted"], name="adaptive_pa_is_acce_fdd7a4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="studentprogress",
            index=models.Index(
                fields=["student_id", "pathway"], name="adaptive_pa_student_f95a36_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="studentprogress",
            index=models.Index(
                fields=["step", "is_completed"], name="adaptive_pa_step_id_64c15f_idx"
            ),
        ),
    ]
