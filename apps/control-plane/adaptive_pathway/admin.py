...
class PathwayRecommendationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("User Feedback", {"fields": ("is_accepted", "feedback_score")}),
...
class ContentEmbeddingAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Content", {"fields": ("text_content", "embedding_vector")}),
        ("Similarity Cache", {"fields": ("similar_content",)}),
