    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.SlugField(
                        help_text="URL-safe identifier", max_length=255, unique=True
                    ),
                ),
                (
                    "domain",
                    models.CharField(
                        blank=True, help_text="Custom domain (optional)", max_length=255
                    ),
                ),
                (
                    "status",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "api_calls_limit",
                    models.IntegerField(default=10000, help_text="API calls per month"),
                ),
                ...
                (
                    "storage_limit_gb",
                    models.FloatField(default=10.0, help_text="Storage limit in GB"),
                ),
                ("storage_used_gb", models.FloatField(default=0.0)),
                (
                    "max_users",
                    models.IntegerField(default=5, help_text="Maximum number of users"),
                ),
