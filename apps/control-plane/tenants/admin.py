...
class TenantAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ...
        ("Metadata", {
            "fields": ["created_at", "updated_at", "activated_at", "suspended_at", "suspension_reason"]
        }),
        ("Settings", {
            "fields": ["settings"],
            "classes": ["collapse"]
...
class TenantQuotaAdmin(admin.ModelAdmin):
    list_display = ["tenant", "api_calls_used", "api_calls_limit", "ai_tokens_used", "ai_tokens_limit"]
...
class TenantAPIKeyAdmin(admin.ModelAdmin):
    list_display = ["name", "tenant", "key_prefix", "is_active", "created_at", "expires_at"]
