...
class ASQAStandardAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Content", {"fields": ("full_text", "requirements")}),
        ("Metadata", {"fields": ("is_active", "effective_date", "version")}),
...
class ASQAClauseAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("standard", "clause_number", "title")}),
        ("Content", {"fields": ("clause_text", "evidence_required", "keywords")}),
        ("Compliance", {"fields": ("compliance_level", "is_active")}),
        ("Audit", {"fields": ("created_at", "updated_at"), "classes": ("collapse",)}),
    )
...
class PolicyAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Content", {"fields": ("content", "version", "file_path")}),
        ("Status & Dates", {"fields": ("status", "effective_date", "review_date")}),
        (
            "Compliance",
            {
...
class ComparisonResultAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "Review",
            {"fields": ("reviewed_by", "reviewed_at"), "classes": ("collapse",)},
        ),
        ("Audit", {"fields": ("comparison_date",), "classes": ("collapse",)}),
    )
...
class ComparisonSessionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Standards", {"fields": ("standards_compared",)}),
        (
            "Results",
            {
                "fields": (
