...
class AttendanceRecord(models.Model):
    ...
    heatmap = models.ForeignKey(EngagementHeatmap, on_delete=models.CASCADE, related_name='attendance_records')
    tenant = models.CharField(max_length=100, db_index=True)
    student_id = models.CharField(max_length=100, db_index=True)
...
class LMSActivity(models.Model):
    ...
    heatmap = models.ForeignKey(EngagementHeatmap, on_delete=models.CASCADE, related_name='lms_activities')
    tenant = models.CharField(max_length=100, db_index=True)
    student_id = models.CharField(max_length=100, db_index=True)
    ...
    interaction_count = models.PositiveIntegerField(
        default=1,
        help_text="Number of clicks, views, or interactions"
    )
...
class DiscussionSentiment(models.Model):
    ...
    heatmap = models.ForeignKey(EngagementHeatmap, on_delete=models.CASCADE, related_name='discussion_sentiments')
    tenant = models.CharField(max_length=100, db_index=True)
    student_id = models.CharField(max_length=100, db_index=True)
    ...
    def __str__(self):
        return f"{self.sentiment_number} - {self.sentiment_label} ({self.sentiment_score})"
...
class EngagementAlert(models.Model):
    ...
    heatmap = models.ForeignKey(EngagementHeatmap, on_delete=models.CASCADE, related_name='engagement_alerts')
    tenant = models.CharField(max_length=100, db_index=True)
    student_id = models.CharField(max_length=100, db_index=True)
    student_name = models.CharField(max_length=200)
