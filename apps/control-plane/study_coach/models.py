...
class ChatSession(models.Model):
    ...
    # Context tracking
    referenced_materials = models.JSONField(default=list)  # Course materials, documents, etc.
...
class ChatMessage(models.Model):
    ...
    intent_detected = models.CharField(max_length=200, blank=True)  # question, clarification, etc.
...
class KnowledgeDocument(models.Model):
    ...
    vector_id = models.CharField(max_length=100, unique=True, null=True, blank=True)  # ID in vector DB
...
class CoachConfiguration(models.Model):
    ...
    personality_traits = models.JSONField(default=list)  # patient, empathetic, motivating
