    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "system_prompt",
                    models.TextField(default="You are a helpful AI study coach."),
                ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant", "student_id", "-created_at"],
                        name="study_coach_tenant_53ff92_idx",
                    ),
                    models.Index(
                        fields=["status", "-created_at"],
                        name="study_coach_status_34c120_idx",
                    ),
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant", "subject", "document_type"],
                        name="study_coach_tenant_88e2ed_idx",
                    ),
                    models.Index(
                        fields=["vector_id"], name="study_coach_vector__454973_idx"
                    ),
                ],
            },
        ),
