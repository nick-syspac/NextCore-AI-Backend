...
class ChatSessionListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ChatSession
        fields = ['id', 'session_number', 'student_name', 'subject', 'topic', 
                  'session_type', 'status', 'message_count', 'satisfaction_rating',
...
class KnowledgeDocumentSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = '__all__'
        read_only_fields = ['document_number', 'vector_id', 'retrieval_count', 
