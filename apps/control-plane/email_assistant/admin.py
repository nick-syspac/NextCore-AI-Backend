...
class StudentMessageAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Content", {"fields": ("subject", "message_body", "received_date")}),
        (
            "Classification",
            {
                "fields": (
        ...
        ("Status", {"fields": ("status", "requires_human_review")}),
        ("Context", {"fields": ("conversation_thread", "previous_message_count")}),
...
class DraftReplyAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Draft Information", {"fields": ("draft_number", "student_message")}),
        ("Content", {"fields": ("reply_subject", "reply_body")}),
        (
            "Generation Settings",
            {
                "fields": (
        ...
        ("Timestamps", {"fields": ("generated_at", "sent_at")}),
    )
...
class MessageTemplateAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Content", {"fields": ("template_body", "placeholders")}),
        ("Tone Settings", {"fields": ("default_tone", "formality_level")}),
        ("Usage Tracking", {"fields": ("usage_count", "success_rate", "last_used_at")}),
        ("Status", {"fields": ("is_active", "is_system_template", "created_by")}),
        ("Metadata", {"fields": ("created_at", "updated_at")}),
    )
...
class ReplyHistoryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Final Content", {"fields": ("final_subject", "final_reply_body")}),
        (
            "Timing Metrics",
            {
                "fields": (
        ...
        (
            ...
            {
                "fields": (
                    "estimated_manual_time_seconds",
                    "time_saved_seconds",
                    "time_saved_percentage",
                )
            },
        ),
        ("Sender Info", {"fields": ("sent_by", "sent_at")}),
        (
            "Quality Feedback",
            {
                "fields": (
