...
class MicroCredential(models.Model):
    ...
    # Basic Information
    tenant = models.ForeignKey(Tenant, on_delete=models.CASCADE, related_name='micro_credentials')
    ...
    delivery_mode = models.CharField(max_length=50, choices=DELIVERY_MODE_CHOICES, default='blended')
    ...
    tags = models.JSONField(default=list, help_text="Searchable tags for categorization")
    skills_covered = models.JSONField(default=list, help_text="List of specific skills")
    industry_sectors = models.JSONField(default=list, help_text="Relevant industry sectors")
    aqf_level = models.CharField(max_length=50, blank=True, help_text="Equivalent AQF level")
    ...
    # Metadata
    created_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name='created_micro_credentials')
...
class MicroCredentialVersion(models.Model):
    ...
    content_snapshot = models.JSONField(help_text="Full snapshot of the micro-credential at this version")
