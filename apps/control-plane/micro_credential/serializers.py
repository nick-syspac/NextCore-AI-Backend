...
class MicroCredentialSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'duration_hours', 'delivery_mode', 'delivery_mode_display',
            'target_audience', 'learning_outcomes',
            'source_units', 'compressed_content',
            'tags', 'skills_covered', 'industry_sectors', 'aqf_level',
            'assessment_strategy', 'assessment_tasks',
            'price', 'max_participants', 'prerequisites',
            'status', 'status_display', 'gpt_generated', 'gpt_model_used',
            'generation_time_seconds',
            'created_by', 'created_by_details', 'enrollment_count',
            'created_at', 'updated_at', 'published_at'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at', 'gpt_generated', 
                           'gpt_model_used', 'generation_time_seconds']
...
class MicroCredentialVersionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'micro_credential', 'version_number', 'change_summary',
            'content_snapshot', 'created_by', 'created_by_details', 'created_at'
        ]
...
class MicroCredentialEnrollmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'micro_credential', 'micro_credential_details',
            'student_name', 'student_email', 'student_id',
            'status', 'status_display',
            'enrolled_at', 'started_at', 'completed_at', 'withdrawn_at',
            'progress_data'
        ]
