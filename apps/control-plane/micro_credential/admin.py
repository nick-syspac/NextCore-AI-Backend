...
class MicroCredentialAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Units and Content", {"fields": ("source_units", "compressed_content")}),
        (
            "Metadata",
            {"fields": ("tags", "skills_covered", "industry_sectors", "aqf_level")},
        ),
        ("Assessment", {"fields": ("assessment_strategy", "assessment_tasks")}),
        ("Enrollment", {"fields": ("price", "max_participants", "prerequisites")}),
        (
            "AI Generation",
            {
                "fields": (
