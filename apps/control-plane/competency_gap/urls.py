...
from .views import (
    TrainerQualificationViewSet,
    UnitOfCompetencyViewSet,
    TrainerAssignmentViewSet,
    CompetencyGapViewSet,
    QualificationMappingViewSet,
    ComplianceCheckViewSet,
)

router = DefaultRouter()
router.register(
    r"qualifications", TrainerQualificationViewSet, basename="qualification"
)
...
router.register(
    r"compliance-checks", ComplianceCheckViewSet, basename="compliance-check"
)
