    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["tenant", "check_status"],
                        name="competency__tenant_572a8d_idx",
                    ),
                    models.Index(
                        fields=["created_at"], name="competency__created_b597e6_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["tenant", "source_qualification_code"],
                        name="competency__tenant_403d48_idx",
                    ),
                    models.Index(
                        fields=["match_strength"], name="competency__match_s_8bf687_idx"
                    ),
                ],
            ...
            options={
                "indexes": [
                    models.Index(
                        ...
                        name="competency__tenant_f4663c_idx",
                    ),
                    models.Index(
                        fields=["verification_status", "expiry_date"],
                        name="competency__verific_8ab3f1_idx",
                    ),
                    models.Index(
                        fields=["qualification_code"],
                        name="competency__qualifi_cdf40c_idx",
                    ),
                ],
            ...
            options={
                "indexes": [
                    models.Index(
                        ...
                        name="competency__tenant_25f80c_idx",
                    ),
                    models.Index(
                        fields=["unit_code"], name="competency__unit_co_504ac9_idx"
                    ),
                ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="competency_gap.unitofcompetency",
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="gaps",
                        to="competency_gap.trainerassignment",
                    ),
                ),
                (
                    "unit",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["tenant", "trainer_id"], name="competency__tenant_874adc_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="trainerassignment",
            index=models.Index(
                fields=["assignment_status"], name="competency__assignm_cdacef_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="trainerassignment",
            index=models.Index(
                fields=["unit", "trainer_id"], name="competency__unit_id_00665f_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["tenant", "trainer_id"], name="competency__tenant_e07b54_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="competencygap",
            index=models.Index(
                fields=["gap_severity", "is_resolved"],
                name="competency__gap_sev_c3bb20_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="competencygap",
