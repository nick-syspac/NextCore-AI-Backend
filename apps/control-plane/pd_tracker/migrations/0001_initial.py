    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant", "trainer_id", "-start_date"],
                        name="pd_tracker__tenant_f70ff4_idx",
                    ),
                    models.Index(
                        fields=["status", "verification_status"],
                        name="pd_tracker__status_210ae4_idx",
                    ),
                    models.Index(
                        fields=["activity_type", "-start_date"],
                        name="pd_tracker__activit_381ba1_idx",
                    ),
                ],
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="pd_suggestions",
                        to="pd_tracker.trainerprofile",
                    ),
                ),
            ],
            options={
