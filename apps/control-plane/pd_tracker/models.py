...
class PDSuggestion(models.Model):
    ...
    trainer_profile = models.ForeignKey(
        TrainerProfile, on_delete=models.CASCADE, related_name="pd_suggestions"
    )
    ...
    linked_activity = models.ForeignKey(
        PDActivity, on_delete=models.SET_NULL, null=True, blank=True
    )
...
class ComplianceCheck(models.Model):
    ...
    trainer_profile = models.ForeignKey(
        TrainerProfile, on_delete=models.CASCADE, related_name="compliance_checks"
    )
