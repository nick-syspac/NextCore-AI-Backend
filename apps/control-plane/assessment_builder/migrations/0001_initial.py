    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "unit_code",
                    models.CharField(
                        help_text="Training package unit code (e.g., BSBWHS211)",
                        max_length=50,
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="e.g., BSB - Business Services",
                        max_length=100,
                    ),
                ),
                (
                    "unit_release",
                    models.CharField(
                        blank=True, help_text="Release number", max_length=20
                    ),
                ),
                (
                    "assessment_type",
                ...
                (
                    "context",
                    models.TextField(
                        blank=True, help_text="Assessment context and scenario"
                    ),
                ),
                (
                    "conditions",
                ...
                (
                    "ai_model",
                    models.CharField(
                        blank=True, help_text="e.g., GPT-4", max_length=50
                    ),
                ),
                (
                    "ai_prompt",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "task_number",
                    models.CharField(help_text="e.g., '1', '1a', 'A.1'", max_length=20),
                ),
                (
                    "task_type",
                    models.CharField(
                ...
                (
                    "question",
                    models.TextField(help_text="The task question or instruction"),
                ),
                (
                    "context",
                    models.TextField(
                ...
                (
                    "marks_available",
                    models.IntegerField(
                        blank=True, help_text="Total marks for this task", null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "criterion_text",
                    models.TextField(help_text="What the student must demonstrate"),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["tenant", "status"], name="assessment__tenant__7edc48_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="assessment",
            index=models.Index(
                fields=["unit_code"], name="assessment__unit_co_f8f65a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="assessment",
            index=models.Index(
                fields=["assessment_type"], name="assessment__assessm_d4a8d3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="assessment",
            index=models.Index(
                fields=["created_at"], name="assessment__created_5008ba_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="assessmentgenerationlog",
            index=models.Index(
                fields=["assessment", "performed_at"],
                name="assessment__assessm_90f9fc_idx",
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="assessment__assessm_936243_idx",
            ),
        ),
    ]
