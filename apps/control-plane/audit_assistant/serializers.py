...
class EvidenceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Evidence
        fields = [
            'id', 'evidence_number', 'title', 'description', 'evidence_type',
            'file', 'file_url', 'file_name', 'file_size', 'extracted_text',
            'ner_entities', 'ner_processed_at', 'status', 'tags',
            'evidence_date', 'uploaded_at', 'uploaded_by', 'uploaded_by_name',
            'reviewed_at', 'reviewed_by', 'reviewed_by_name', 'reviewer_notes',
            'tagged_clauses_count', 'auto_tagged_count'
        ]
        read_only_fields = ['uploaded_at', 'ner_processed_at', 'file_size', 'extracted_text']
...
class ClauseEvidenceSerializer(serializers.ModelSerializer):
    ...
    clause_number = serializers.CharField(source='asqa_clause.clause_number', read_only=True)
    clause_title = serializers.CharField(source='asqa_clause.title', read_only=True)
    clause_compliance_level = serializers.CharField(source='asqa_clause.compliance_level', read_only=True)
    ...
    class Meta:
        ...
        fields = [
            'id', 'asqa_clause', 'clause_number', 'clause_title', 'clause_compliance_level',
            'evidence', 'evidence_number', 'evidence_title', 'evidence_type',
            'mapping_type', 'mapping_type_display', 'confidence_score',
            'matched_entities', 'matched_keywords', 'rule_name', 'rule_metadata',
            'is_verified', 'verified_by', 'verified_by_name', 'verified_at',
            'relevance_notes', 'created_at', 'updated_at'
        ]
...
class AuditReportClauseSerializer(serializers.ModelSerializer):
    ...
    clause_number = serializers.CharField(source='asqa_clause.clause_number', read_only=True)
    clause_title = serializers.CharField(source='asqa_clause.title', read_only=True)
    clause_text = serializers.CharField(source='asqa_clause.clause_text', read_only=True)
    clause_compliance_level = serializers.CharField(source='asqa_clause.compliance_level', read_only=True)
    standard_name = serializers.CharField(source='asqa_clause.standard.title', read_only=True)
    ...
    class Meta:
        ...
        fields = [
            'id', 'asqa_clause', 'clause_number', 'clause_title', 'clause_text',
            'clause_compliance_level', 'standard_name',
            'compliance_status', 'compliance_status_display',
            'evidence_count', 'verified_evidence_count', 'evidence_details',
            'finding', 'severity', 'recommendation',
            'assessed_by', 'assessed_by_name', 'assessed_at', 'notes',
            'created_at', 'updated_at'
        ]
        read_only_fields = ['evidence_count', 'verified_evidence_count', 'created_at', 'updated_at']
...
class AuditReportSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'asqa_standards', 'standards_count', 'standards_details',
            'audit_period_start', 'audit_period_end',
            'status', 'status_display',
            'total_clauses', 'clauses_with_evidence', 'clauses_without_evidence',
            'compliance_percentage',
            'critical_clauses_count', 'critical_clauses_covered', 'critical_compliance_percentage',
            'total_evidence_count', 'auto_tagged_count', 'manually_tagged_count',
        ...
        read_only_fields = [
            'created_at', 'updated_at', 'total_clauses', 'clauses_with_evidence',
            'clauses_without_evidence', 'compliance_percentage',
            'critical_clauses_count', 'critical_clauses_covered', 'critical_compliance_percentage',
            'total_evidence_count', 'auto_tagged_count', 'manually_tagged_count',
            'verified_evidence_count'
        ]
...
class EvidenceUploadSerializer(serializers.Serializer):
    ...
    auto_tag = serializers.BooleanField(default=True, help_text="Enable auto-tagging via NER")
...
class ClauseEvidenceGapSerializer(serializers.Serializer):
    ...
    clause_number = serializers.CharField(source='asqa_clause.clause_number', read_only=True)
    clause_title = serializers.CharField(source='asqa_clause.title', read_only=True)
    compliance_level = serializers.CharField(source='asqa_clause.compliance_level', read_only=True)
