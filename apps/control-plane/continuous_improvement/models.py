...
class ImprovementCategory(models.Model):
    ...
    tenant = models.ForeignKey('tenants.Tenant', on_delete=models.CASCADE, related_name='improvement_categories')
...
class ImprovementAction(models.Model):
    ...
    # Basic info
    tenant = models.ForeignKey('tenants.Tenant', on_delete=models.CASCADE, related_name='improvement_actions')
    ...
    ai_summary = models.TextField(
        blank=True,
        help_text="AI-generated summary of the action"
    )
    ai_keywords = models.JSONField(
        default=list,
        help_text="AI-extracted keywords from description"
    )
...
class ImprovementReview(models.Model):
    ...
    # Basic info
    tenant = models.ForeignKey('tenants.Tenant', on_delete=models.CASCADE, related_name='improvement_reviews')
    ...
    ai_summary = models.TextField(
        blank=True,
        help_text="AI-generated summary of review findings"
    )
    ai_trends = models.JSONField(
        default=list,
        help_text="AI-identified trends and patterns"
    )
    ...
    action_items = models.JSONField(
        default=list,
        help_text="New actions arising from review"
    )
