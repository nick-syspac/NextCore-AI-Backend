...
class EligibilityDecisionSerializer(serializers.ModelSerializer):
    ...
    decided_by_user_details = UserMinimalSerializer(source='decided_by_user', read_only=True)
...
class CreateOverrideSerializer(serializers.Serializer):
    ...
    final_outcome = serializers.ChoiceField(choices=['eligible', 'ineligible', 'review'])
...
class UploadEvidenceSerializer(serializers.Serializer):
    ...
    type = serializers.ChoiceField(choices=[
        'id', 'concession', 'residency', 'visa', 'qualification',
