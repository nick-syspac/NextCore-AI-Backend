...
class AssessorDecisionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Decision Information", {"fields": ("decision_number", "session")}),
        (
            "Student Details",
        ...
        (
            "Assessor Details",
            {
                "fields": (
                    ...
                    "assessor_name",
                    "marked_at",
                    "marking_time_minutes",
                )
            },
        ),
        ("Scoring", {"fields": ("score", "max_score", "grade", "criterion_scores")}),
        (
            "Flags",
            {
...
class OutlierDetectionAdmin(admin.ModelAdmin):
    ...
    search_fields = (
        "outlier_number",
        "decision__student_id",
        "decision__assessor_name",
    )
